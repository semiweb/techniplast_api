...
# Unit tests for Tecniplast::Cage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'Cage' do
  before do
    # run before each test
    @instance = Tecniplast::Cage.new
  end
  ...
  describe 'test an instance of Cage' do
    it 'should create an instance of Cage' do
      expect(@instance).to be_instance_of(Tecniplast::Cage)
    end
  end
