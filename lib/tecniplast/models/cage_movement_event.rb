...
module Tecniplast
  class CageMovementEvent
    ...
    def valid?
      movement_type_validator = EnumAttributeValidator.new('String', ['ON_THE_WIRELESS_READER', 'OFF_THE_WIRELESS_READER'])
    ...
    def movement_type=(movement_type)
      validator = EnumAttributeValidator.new('String', ['ON_THE_WIRELESS_READER', 'OFF_THE_WIRELESS_READER'])
    ...
    def hash
      [timestamp, cage_id, movement_type, position, rack, ams_rack_id, room, floor, building, facility, cage_online, user, token].hash
    end
