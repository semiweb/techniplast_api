...
module OpenapiClient
  class CageMovementEvents
    ...
    def self.openapi_types
      {
        :'type' => :'String',
        :'triggered_by' => :'String',
        :'alarms' => :'Array<CageMovementEvent>'
      }
    end
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('String', ['NOTIFY_CAGE_MOVEMENT'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ['NOTIFY_CAGE_MOVEMENT'])
