...
module OpenapiClient
  class AuthenticationToken
    ...
    # When authentication method persistent token is employed the same header employed by OAuth2 is used. A header field Authorization is defined, with the Bearer value followed by the token, e.g.: Authorization: Bearer 0b79bab50daca910b000d4f1a2b675d604257e42
    attr_accessor :token
    ...
    def valid?
      authentication_method_validator = EnumAttributeValidator.new('String', ['PERSISTENT_TOKEN'])
    ...
    def authentication_method=(authentication_method)
      validator = EnumAttributeValidator.new('String', ['PERSISTENT_TOKEN'])
    ...
    def hash
      [authentication_method, token].hash
    end
